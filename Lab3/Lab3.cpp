...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_DRAWITEM:
        ...
        if (lpInfo->CtlID == ID_BUTTON_1) {
            ...
            FillRect(lpInfo->hDC, &rcItem, CreateSolidBrush(RGB(105, 165, 0)));
            POINT arr[4];
            INT width, height;
        ...
        if (lpInfo->CtlID == ID_BUTTON_2) {
            RECT rcItem;
            rcItem = lpInfo->rcItem;
            FillRect(lpInfo->hDC, &rcItem, CreateSolidBrush(RGB(100, 255, 0)));
            POINT arr[4];
            INT width, height;
            width = rcItem.right - rcItem.left;
            height = rcItem.bottom - rcItem.top;
            ...
            FillRect(lpInfo->hDC, &rcIm, CreateSolidBrush(RGB(105, 0, 0)));
        }
        break;
    case WM_DESTROY:
        PostQuitMessage(0);
